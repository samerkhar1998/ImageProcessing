...
if __name__ == "__main__":
    ...
    path_image = r'C:\Users\freaz\Desktop\image processing\abed\Images\darkimage.tif'
    darkimg = cv2.imread(path_image)
    darkimg_gray = cv2.cvtColor(darkimg, cv2.COLOR_BGR2GRAY)

    path_image2 = r'C:\Users\freaz\Desktop\image processing\abed\Images\fruit.tif'
