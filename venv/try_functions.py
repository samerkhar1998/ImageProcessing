...
if __name__ == "__main__":
    ...
    #
    # Range = [0,250]
    # enhanced_img, a, b = contrastEnhance(darkimg,Range)  # add parameters
    #
    # # display images
    # plt.figure()
    # plt.subplot(1, 2, 1)
    ...
    #
    # print("b ------------------------------------\n")
    # enhanced2_img, a, b = contrastEnhance(enhanced_img, [100,255])  # add parameters
    #
    # # print a,b
    ...
    # plt.figure()
    # plt.subplot(1, 1, 1)
    # plt.imshow(enhanced2_img,cmap='gray')
    # plt.title('enhanced again')
